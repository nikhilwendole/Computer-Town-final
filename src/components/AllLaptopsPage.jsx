...
//         {loading ? (
//           <div className="text-center py-16">
//             <p className="text-gray-500 text-lg">Loading laptops...</p>
//           </div>
//         ) : filteredLaptops.length === 0 ? (
//           <div className="text-center py-16">
//             <p className="text-gray-500 text-lg">No laptops match your filters.</p>
...
//               <div
//                 key={laptop._id}
//                 onClick={() => handleLaptopClick(laptop._id)}
//                 className="group bg-white rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 cursor-pointer overflow-hidden"
//               >
//                 <div className="w-full h-48 md:h-56 p-4 flex items-center justify-center bg-gray-50 rounded-t-xl transition-transform duration-500 group-hover:scale-105">
//                   <img
//                     src={
//                       laptop.images?.[0]
//                         ? `http://localhost:5000/${laptop.images[0]}`
//                         : "https://placehold.co/400x300?text=No+Image"
//                     }
//                     alt={laptop.name}
//                     className="max-h-full max-w-full object-contain rounded-lg"
...
//       <div className="max-w-8xl mx-auto">
//         {loading ? (
//           <p className="text-center text-gray-500 text-lg">Loading laptops...</p>
//         ) : filteredLaptops.length === 0 ? (
//           <div className="text-center py-16">
//             <p className="text-gray-500 text-lg">No laptops match your filters.</p>
//             <button
...
//                 <div className="w-full h-48 md:h-56 p-4 flex items-center justify-center bg-gray-50 rounded-t-xl transition-transform duration-500 group-hover:scale-105">
//                   <img
//                     src={laptop.images?.[0] ? `http://localhost:5000${laptop.images[0]}` : "https://placehold.co/400x300?text=No+Image"}
//                     alt={laptop.name}
//                     className="max-h-full max-w-full object-contain rounded-lg"
//                   />
//                 </div>
